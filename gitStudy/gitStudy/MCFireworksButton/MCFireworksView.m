...
- (void)setup {
	...
	_explosionLayer.emitterSize = CGSizeMake(300, 0);
	...
	_chargeLayer.emitterSize = CGSizeMake(300, 0);
...
- (void)explode {
	...
	[self.explosionLayer setValue:@5000 forKeyPath:@"emitterCells.explosion.birthRate"];
